...
class Scoreboard():
    ...
    def prep_score(self):
        ...
        self.score_image = self.font.render("SC: " + score_str, True, self.text_color, self.ai_settings.bg_color)
    ...
    def prep_high_score(self):
        """Transforma a pontuação máxima em um imagem renderizada."""
        high_score = int(round(self.stats.high_score, -1))
        high_score_str = "{:,}".format(high_score)
        self.high_score_image = self.font.render("MX: " + high_score_str, True, self.text_color, self.ai_settings.bg_color)
    ...
    def prep_level(self):
        ...
        self.level_image = self.font.render(str("LV: " + self.level_str), True, self.text_color, self.ai_settings.bg_color)
